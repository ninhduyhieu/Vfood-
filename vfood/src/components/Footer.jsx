    ...
    return (
        <footer className={'text-white py-20 bg_gradient'}>
            <div className={'container mx-auto px-20 lg:px-20 py-20 flex flex-col gap-10 md:flex-row justify-between border-t border-slate-800'}>
                <div className={'flex'}>
                    <p className={'font-bold text-center'}>
                        <b className={'text-xl'}>&nbsp;V<span className={'text-red-600'}>Food</span></b>
                    </p>
                </div>
                ...
                <div className=''>
                    ...
                    <div className={'flex flex-col text-start mb-4 md:mb-0'}>
                        <a href={'#'} className={'block md:inline-block py-2 hover:text-gray-500'}>
                            Home
                        </a>
                        <a href={'#'} className={'block md:inline-block py-2 hover:text-gray-500'}>
                            About
            ...
            <div className={'flex items-center justify-center py-10'}>
                <span className={'text-gray-400 leading-10'}>Ninh Duy Hieu &copy; 2023</span>
            </div>
        </footer>
    )
}
